...
class TestUserManagement(TestCase):
    def setUp(self):
        ...
        self.superuser = ShopUser.objects.create_superuser('django2',
                                                           'dgango@geekshop.local', 'geekbrains')
        self.user =ShopUser.objects.create_user('tarantino',
                                                'tarantino@geekshop.local', 'geekbrains')
        self.user_first_name = ShopUser.objects.create_user('tarantino2', 'tarantino2@local',
                                                            'geekbrains', first_name='jek')
    ...
    def test_user_login(self):
        ...
        self.assertNotEqual(response, 'Пользователь', 200)
    ...
    def test_user_register(self):
        ...
        self.assertEqual(str(response.context['user']), new_user_data['username'])
